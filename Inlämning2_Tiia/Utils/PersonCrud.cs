...
namespace Inlämning2_Tiia
{
    public class PersonCrud
    {
        public void Start()
        {
            ...
            {
                PersonsAdded(); //lägger till alla personer till listan
                db.SaveChanges();
            }
        ...
        private static void PersonsAdded()
        {
            CreatePerson("Rhaegar", "Targaryen"); //ID = 1
            CreatePerson("Viserys", "Targaryen"); //ID = 2
            CreatePerson("Daenerys", "Targaryen"); //ID = 3
            CreatePerson("Elia", "Martell");
            CreatePerson("Aerys", "Targaryen");
            CreatePerson("Rhaella", "Targaryen");
            CreatePerson("Lyanna", "Stark");
            CreatePerson("Jon", "Snow");
            CreatePerson("Rhaenys", "Targaryen");
            CreatePerson("Aegon", "Targaryen");
        }
